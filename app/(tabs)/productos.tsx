          ...
          <View style={ms.modalOverlay}>
            <View style={ms.modalBox}>
              <View style={ms.modalIconWrap}>
                <Ionicons name="pricetag" size={32} color="#63348C" />
              </View>
              ...
              <View style={ms.modalBtns}>
                ...
                <TouchableOpacity style={ms.modalConfirmBtn} onPress={savePrice} disabled={saving}>
...
const ds = StyleSheet.create({
  ...
  addBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#10B981', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10, shadowColor: '#10B981', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.2, shadowRadius: 6 },
  ...
  headerSearchFocused: { borderColor: '#63348C', shadowColor: '#63348C', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.1, shadowRadius: 10, backgroundColor: '#fff' },
  ...
  catChipActive: { backgroundColor: '#63348C', borderColor: '#63348C' },
  ...
  card: { width: '15.8%', backgroundColor: '#fff', borderRadius: 14, borderWidth: 1, borderColor: '#F1F5F9', overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.02, shadowRadius: 10 },
  statusBadge: { position: 'absolute', top: 6, right: 6, paddingHorizontal: 5, paddingVertical: 2, borderRadius: 5, zIndex: 10 },
...
const ms = StyleSheet.create({
  ...
  headerSearchFocused: { borderColor: '#63348C', shadowColor: '#63348C', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.1, shadowRadius: 8, backgroundColor: '#fff' },
  ...
  modalIconWrap: { width: 64, height: 64, borderRadius: 32, backgroundColor: '#F5F0FF', alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
  ...
  modalConfirmBtn: { flex: 1, paddingVertical: 14, borderRadius: 14, alignItems: 'center', backgroundColor: '#63348C' },
